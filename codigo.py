...
Button(root,text="0" , width=11, height=1, font=("arial",30,"bold"),bd=1,fg= '#fff',bg="#2a2d36",command=lambda:show ("4")).place(x=10,y=500)

Button(root,text="x" , width=5, height=1, font=("arial",30,'bold'),bd=1,fg= "#fff",bg="#2a2d36",command=lambda: show ("x")).place(x=290,y=500)
